...
export function useIssues() {
  ...
  async function addIssue(issue) {
    try {
      ...
      if (error) { console.error('addIssue failed:', error.code, error.message, error.details, error.hint); return null }
      return data
    } catch (e) { console.error('addIssue threw:', e); return null }
  }
